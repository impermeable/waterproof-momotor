    ...
    def run(self) -> CheckletResult:
        ...
        for cell in range(0, len(student_codes)):
            ...
            if has_valid_code:
                ...
                SKIPPED.append(CODE_VALID_CASE) # FIXME or does this need to be added to CASES instead?
        ...
        return CheckletResult(
            outcome = Outcome.PASS if any(block["score"] == 0 for block in REPORT) else Outcome.FAIL,
            properties = {
